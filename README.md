...
- Генерировались те части кода, в которых находится код, связынный с GigaChat и Resend (отправка emails, к сожалению отправка работает только на мою почту, потому что сервис бесплатный)
