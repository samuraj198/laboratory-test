...
- Генерировались те части кода, в которых находится код, связынный с GigaChat и Resend (отправка emails, работает отправка только на мою почту, потому что сервис бесплатный)
